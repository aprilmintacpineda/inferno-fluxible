  ...
  return function (WrappedComponent) {
    ...
    return (0, _redefineStaticsJs.default)((0, _infernoCreateClass.createClass)({
      getInitialState: function getInitialState() {
        ...
        if (mapStatesToProps) {
          ...
          this.removeListener = (0, _fluxibleJs.addUpdateListener)(function (updatedStore) {
            _this.setState(mapStatesToProps ? mapStatesToProps(updatedStore) : {});
      ...
      render: function render() {
        return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _objectSpread({}, this.props, this.state, mutations)));
      }
    }), WrappedComponent);
  };
}