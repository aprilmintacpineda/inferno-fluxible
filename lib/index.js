  ...
  return function (WrappedComponent) {
    ...
    return (0, _redefineStaticsJs.default)((0, _infernoCreateClass.createClass)({
      ...
      render: function render() {
        var props = mapStatesToProps && definedMutations ? _objectSpread({}, this.props, this.state, mutations) : mapStatesToProps ? _objectSpread({}, this.props, this.state) : definedMutations ? _objectSpread({}, this.props, mutations) : this.props;
        return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _objectSpread({}, props)));
      }
    }), WrappedComponent);
  };
}