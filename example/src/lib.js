    ...
    function ConnectedComponent(props) {
      ...
      this.render = function () {
        if (mapStatesToProps && definedMutations) {
          return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _objectSpread({}, _this2.props, mutations, _this2.mappedStates)));
        } else if (mapStatesToProps) {
          return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _objectSpread({}, _this2.props, _this2.mappedStates)));
        }

        return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, WrappedComponent, _objectSpread({}, _this2.props, mutations)));
      };
