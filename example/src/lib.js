      ...
      _createClass(Wrapper, [
        ...
        },
        {
          ...
          value: function render () {
            return (0, _inferno.normalizeProps)(
              (0, _inferno.createComponentVNode)(
                2,
                WrappedComponent,
                _extends(
                  {},
                  wantedState ? wantedState((0, _fluxibleJs.getStore)()) : {},
                  wantedMutations
                    ? Object.keys(wantedMutations).reduce(function (mutationCollection, mutation) {
                        return _extends(
                          {},
                          mutationCollection,
                          _defineProperty({}, mutation, function () {
                            for (
                              var _len = arguments.length, payload = Array(_len), _key = 0;
                              _key < _len;
                              _key++
                            ) {
